            ...
            <div class="card-body">
                <table class="table table-bordered" id="dataTable" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $equipamentos = mysqli_query($con, $sql);
                        if ($equipamentos->num_rows) {
                            while ($equipamento = $equipamentos->fetch_object()) {
                                $cod = $equipamento->cod_cliente;
                                $sql = "SELECT cliente.nome FROM cliente WHERE cliente.cod_cliente = ?";
                                $stmt = $con->prepare($sql);
                                $stmt -> bind_param('i', $cod);
                                $stmt->execute();
                                $cliente_equipamentos = $stmt->get_result()->fetch_assoc();
                                $nome_cliente = $cliente_equipamentos['nome'];
                        ?>
