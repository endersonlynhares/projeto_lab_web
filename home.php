...
<body>
  ...
  <main>
    ...
    <div class="px-4 pt-5 my-2 container text-center border-bottom">
      <img src="imgs/logo_os.svg" height="90" class="mb-2" alt="">
      <h2 class="display-5 fw-bold">Sistema de Ordem de Serviços</h2>
      <div class="col-lg-8 mx-auto">
        <p class="lead mb-4">
          Sistema de Ordem de Serviço desenvolvido pela equipe <img src="imgs/logo_os_branco.svg" height="25" style="color:black;" style="max-width:25px;" alt=""> SoftTech (Enderson, Adryelson, Joseano, Ruan e Wenderson)
        </p>
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
          <a href="cadastro_os.php" class="btn btn-primary btn-lg px-4 me-sm-3">Cadastrar OS</a>
          <a href="cadastro_cliente.php" class="btn btn-outline-secondary btn-lg px-4">Cadastrar Cliente</a>
        </div>
      </div>
    </div>
